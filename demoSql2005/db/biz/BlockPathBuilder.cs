...
namespace up7.demoSql2005.db.biz
{
    ...
    public class BlockPathBuilder
    {
        ...
        /// <returns></returns>
        public string part(string idSign,string blockIndex,ref xdb_files fileSvr)
        {
            System.IO.FileInfo f = new System.IO.FileInfo(fileSvr.pathSvr);

            //d:\\soft
            string pathSvr = Path.Combine(f.DirectoryName,idSign);
