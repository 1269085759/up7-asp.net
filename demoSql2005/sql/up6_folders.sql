...
CREATE TABLE [dbo].[up6_folders](
	...
	[fd_name]			[varchar](100) COLLATE Chinese_PRC_CI_AS NULL CONSTRAINT [DF_up6_folders_fd_name]  DEFAULT (''),
	...
	[fd_pathLoc]		[varchar](500) COLLATE Chinese_PRC_CI_AS NULL CONSTRAINT [DF_up6_folders_fd_pathLoc]  DEFAULT (''),
	[fd_pathSvr]		[varchar](500) COLLATE Chinese_PRC_CI_AS NULL CONSTRAINT [DF_up6_folders_fd_pathSvr]  DEFAULT (''),
